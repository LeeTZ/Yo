...
let generate_built_in_types = 
	...
	let log_f_args_str = [{name="str"; actual="str"; type_def=NameMap.find "String" tt}] in
	let log_f_args_int = [{name="integer"; actual="integer"; type_def=NameMap.find "Int" tt}] in
	let log_f_args_double = [{name="float_number"; actual="float_number"; type_def=NameMap.find "Double" tt}] in
